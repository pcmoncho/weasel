...
var FolderComponent = (function () {
    ...
    FolderComponent.prototype.getFolder = function () {
        var _this = this;
        this._processService.getFolder(this.folder).subscribe(function (data) {
            _this.folder = data;
            _this.folderChange.emit(_this.folder);
        });
    };
